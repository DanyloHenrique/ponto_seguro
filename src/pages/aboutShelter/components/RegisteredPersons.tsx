...
export default function RegisteredPersons({
  ...
  return (
    <section className="mb-8 flex w-full flex-col gap-4 rounded-2xl bg-white px-3 py-4 text-left lg:mb-0 lg:h-full lg:w-2/5 lg:overflow-hidden">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-2 pr-4">
        {checkIns.length > 0 ? (
          checkIns.map((person) => (
            <div
              key={person.id}
